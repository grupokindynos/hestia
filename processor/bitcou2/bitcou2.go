...
func main() {
	...
	for _, bitcouCountry := range countries {
		if bitcouCountry.ID == "BR" || bitcouCountry.ID == "AU" || bitcouCountry.ID == "CO" || bitcouCountry.ID == "IN" || bitcouCountry.ID == "ZA" || bitcouCountry.ID == "TR" || bitcouCountry.ID == "GB" || bitcouCountry.ID == "NG" {
